	...
	<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
		<div>
			<h2 class="pb-2 border-bottom">
				<a href="/board/consultation"
					style="text-decoration-line: none; color: black;">공감공간</a>
			</h2>
		</div>
			...
			<form role="form" method="get">
					...
					<c:when test="${null != memberDTO}">
						<div>
							<button type="submit" id="create_btn"
								class="btn btn-dark btn-sm mb-1">글쓰기</button>
						</div>
					</c:when>
				</c:choose>
				...
				<div class="search input-group text-center">
					...
					<input type="text" class="form-control" name="keyword"
						id="keywordInput" placeholder="Search" value="${scri.keyword}" />
					<div class="input-group-btn">
						<button class="btn btn-dark text-center" id="searchBtn"
				...
				<ul class="pagination  justify-content-center">
					...
					<c:forEach begin="${pageMaker.startPage}"
						...
						<li class="page-item"><a class="page-link"
							href="consultation${pageMaker.makeSearch(idx)}">${idx}</a></li>
					</c:forEach>
